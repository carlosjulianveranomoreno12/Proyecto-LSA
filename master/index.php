        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-8 animated fadeInRight slow">
              <ul class="nav ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="vista/VentanaEstadistica.php">Acerca de</a>
                </li>
                <li class="iniciar-S nav-item">
                    <a class="nav-link" href="vista/Inicio.php" id="btnLogin">Iniciar sesión</a>
                  </li>
              </ul>
            </div>
          </div>
